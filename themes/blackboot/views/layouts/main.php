...
<body>
	<div class="navbar navbar-inverse navbar-fixed-top">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="#"><img src="<?php echo Yii::app()->request->baseUrl.'/images/vpx.png'; ?>" width="150" height="100"/></a>
				<div class="nav-collapse">
					<?php $this->widget('zii.widgets.CMenu',array(
						...
						'items'=>array(
							...
							array('label'=>'Project', 'url'=>array('/admin/project', 'view'=>'index')),
							array('label'=>'Members', 'url'=>array('/admin/userprofile')),
							array('label'=>'Tasks', 'url'=>array('/admin/projectstatus')),
	...
	<div class="extra">
	  <div class="container">
		<div class="row"><h3 style="margin-top:00px;"align="center"> Ongoing Projects</h3>
			<div class="col-md-3">
				<h4>Nusik</h4>
				<ul>
