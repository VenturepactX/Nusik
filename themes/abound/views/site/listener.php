...
<section class="profile-container">
	...
	<span class="span8  bgcolor-white">
		...
		<div class="row-fluid">
		<section>
		<section class="span12 soundline-data" id="profile-data">
            	<div class="span12">
		<div class="tab-content">
			<div style="width:100%" class="tab-pane" id="playlist" >
			  <table width="100%"><tr><td align="center" valign="top">
			   ...
			   //CVarDumper::dump(Yii::app()->user->id.' , '.$model->users->id,10,1);die;
			   $criteria->condition='users_id='.$model->id;
				 ...
				 if(count($following>0))
				  {
					 foreach($following as $follow)
						{
				 			//CVarDumper::dump($follow->artistsProfile->profile->users,10,1);die;
				...
				<?php  }?>	
					<div class="row-fluid ">
						...
						<h4 class="span8 padding10">	<img src="<?php echo $baseUrl;?>/img/mymusic.png" class="mgright5"/>My Liked</h4>
							<span class="span2 offset2 pull-right mgtop15"><a href="<?php echo $this->createUrl('site/viewList', array('type'=>'liked', 'id'=>$model->users->id));?>" class="listlink ">View All</a></span>
						</span>
